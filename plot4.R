...
## -------------------------- Part 2: Making Plots -------------------------------------
#  PLOT 4: Global Active Power~ Datime / Voltage~Datime / Energy sub metering ~ Datime / Global_reactive_power~datime
...
legend("topright",bty = "n", pch = NA,lwd = 2, col = c("black","red","blue"),
       legend = c("Sub_metering_1","Sub_metering_2","Sub_metering_3"))

with(dt, plot(Datime, Global_reactive_power,
              type = "l",
              xlab = "datetime",
